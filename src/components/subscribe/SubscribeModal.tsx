...
export class SubscribeModal extends React.Component<any, SubscribeState> {
  state = { isOpen: false };
  signupurl = config.siteUrl + "/signup";
    ...
    return (
      <SubscribeOverlay open={this.state.isOpen}>
        ...
        <SubscribeOverlayContent>
          <SubscribeLogo />
          <SubscribeOverlayTitle>ISMS-P check list manager</SubscribeOverlayTitle>
          <SubscribeOverlayDescription>
          </SubscribeOverlayDescription>
          <SubscribeForm />
          <SubscribeOverlayDescription><br></br><br></br>
            Is this your first time? --&gt;  <a href="/signup">Join us</a>
          </SubscribeOverlayDescription>
        </SubscribeOverlayContent>
      </SubscribeOverlay>
    );
